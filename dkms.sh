...
if [[ $dkms_remove = true ]]; then
    ...
    [[ -e $src_dir ]] && sudo rm -f $src_dir && echo "removed $src_dir"
...
[[ ! -e $src_dir ]] && sudo ln -sfn $cur_dir $src_dir
...
sudo dkms install -c dkms.conf --force -m $dkms_name
